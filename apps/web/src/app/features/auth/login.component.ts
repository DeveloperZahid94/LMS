        ...
        <div class="card-body">
          ...
          <form [formGroup]="form" (ngSubmit)="submit()" class="mt-4 space-y-3">
            <label class="form-control w-full">
              <div class="label py-1"><span class="label-text">Tenant slug <span class="text-base-content/50">(blank for SuperAdmin)</span></span></div>
          ...
          <div class="text-xs text-base-content/70 space-y-1">
            ...
            <div>SuperAdmin — <code class="bg-base-200 px-1 rounded">superadmin&#64;lms.local</code> / <code class="bg-base-200 px-1 rounded">SuperAdmin&#64;123</code></div>
          </div>
        </div>
      </div>
    </div>
